...
const DashboardPage = () => {
  ...
  if (error) {
    ...
    } else if (profileInfo.status === "running") {
      return (
        ...
        <UserLayout header={`Dashboard`}>
          <div className="bg-white shadow sm:rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="mt-2 max-w-xl text-sm leading-5 text-gray-500">
                <p>
                  Have some really cool new contributions/repositories added to
                  your profile? No worries, let's start the analysis again!
                </p>
              </div>
              <div className="mt-5">
                <button
