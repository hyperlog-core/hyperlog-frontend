...
const RegisterPage = () => {
  ...
  mutation($email:String!, $f_name:String!, $l_name:String!, $password:String!, $username:String!) {
    register(email:$email, firstName:$f_name, lastName:$l_name, password:$password, username:$username){
      success
      errors
    }
  }
  ...
  const [registerUser, {loading: mutationLoading, error: mutationError, data: mutationData}] = useMutation(MUTATION_USER_REGISTRATION, {
    onError: (err) => console.log(err)
  })

  const NORMAL_INPUT_CLASS = "appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5"
  const ERROR_INPUT_CLASS = "appearance-none block w-full px-3 py-2 border border-red-300 rounded-md text-red-900 placeholder-red-300  focus:outline-none focus:border-red-300 focus:shadow-outline-red transition duration-150 ease-in-out sm:text-sm sm:leading-5"
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          {mutationData && mutationData.register.errors ? (
            <div className="rounded-md bg-red-50 p-4 mb-6">
              <div className="flex">
                ...
                <div className="ml-3">
                  <h3 className="text-sm leading-5 font-medium text-red-800">
                    There were {mutationData.register.errors.length} errors with your submission
                  </h3>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm leading-5 text-green-700">
                    <p>
                      You have been registered successfully! You will be redirected to login in a few seconds.
                    </p>
                  </div>
                  <div className="mt-4">
                    <div className="-mx-2 -my-1.5 flex">
                      <Link to="/login" className="px-2 py-1.5 rounded-md text-sm leading-5 font-medium text-green-800 hover:bg-green-100 focus:outline-none focus:bg-green-100 transition ease-in-out duration-150">
                        Take me there now
                      </Link>
                    </div>
                  </div>
          ...
          <form onSubmit={formik.handleSubmit}>
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                <input
                  ...
                  className={formik.touched.email && formik.errors.email ? ERROR_INPUT_CLASS : NORMAL_INPUT_CLASS} />
            ...
            <div className="mt-6">
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                <input
                  ...
                  className={formik.touched.username && formik.errors.username ? ERROR_INPUT_CLASS : NORMAL_INPUT_CLASS} />
            ...
            <div className="mt-6">
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                <input
                  ...
                  className={formik.touched.password && formik.errors.password ? ERROR_INPUT_CLASS : NORMAL_INPUT_CLASS} />
            ...
            <div className="mt-6">
              <span className="block w-full rounded-md shadow-sm">
                <button type="submit" className="w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-gray-600 hover:bg-gray-500 focus:outline-none focus:border-gray-700 focus:shadow-outline-gray active:bg-gray-700 transition duration-150 ease-in-out">
                  {mutationLoading ? <PulseLoader size="10" color="#ffffff" /> : "Register"}
                </button>
              </span>
            </div>
          </form>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <span className="block w-full rounded-md shadow-sm">
                <Link to="/login" className="w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white text-gray-700 bg-gray-100 hover:bg-gray-50 focus:outline-none focus:border-gray-300 focus:shadow-outline-gray active:bg-gray-200 transition ease-in-out duration-150">
                  Login
                </Link>
              </span>
            </div>
